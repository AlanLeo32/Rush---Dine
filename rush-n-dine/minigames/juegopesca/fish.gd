...
var fish_sprite : AnimatedSprite2D
var aquaContainer : Control
...
func _ready() -> void:
	fish_sprite = $AnimatedSprite2D
	aquaContainer = get_node("../FishingGame/PanelContainer/MarginContainer/VBoxContainer/aquaContainer")
